...
const PRIVATE_KEY = process.env.PRIVATE_KEY || "a4b7bb5c524e0431096859ec12606ef298bb517dae0a8939af8b1346f856abb4"; // Ensure this is securely stored
...
try {
  ...
  const maxPriorityFeePerGas = feeData.maxPriorityFeePerGas.add(ethers.utils.parseUnits("30", "gwei"));
  const maxFeePerGas = feeData.maxFeePerGas.add(ethers.utils.parseUnits("60", "gwei"));
